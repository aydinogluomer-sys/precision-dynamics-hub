    ...
    >
      <motion.div style={{ y, rotateZ: rotateStr }} className="w-full h-full">
        ...
        >
          ...
          <path
            d="M0 120C200 60 500 30 720 50C940 70 1200 100 1440 80V160H0V120Z"
            fill={fillColor}
            opacity={0.3}
          />
          {/* Foreground layer — main curve */}
          <path
            d="M0 90C240 30 480 0 720 15C960 30 1200 75 1440 60V160H0V90Z"
            fill={fillColor}
          />
        </svg>
      </motion.div>
