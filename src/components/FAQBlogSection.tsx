...
const FAQBlogSection = () => {
  ...
  return (
    <section id="sss" className="section-industrial border-y border-border" style={{ backgroundColor: "rgba(228,237,237,0.5)" }}>
      <style>{`.dark #sss { background-color: hsl(var(--section-mist)) !important; }`}</style>
