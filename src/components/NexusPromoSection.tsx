...
import {
  ...
  Cpu, Brain, Sparkles, Lock, ChevronRight } from
"lucide-react";
  ...
  return (
    <section
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <TextReveal>
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
            ...
            <motion.div
              ...
              <Link
                to="/musteri-paneli"
                className="group inline-flex items-center gap-2 px-7 py-3.5 text-foreground font-bold text-sm uppercase tracking-wider transition-all bg-card"
        ...
        {/* Bottom Security Bar */}
        <motion.div
          className="relative p-6 border border-border overflow-hidden bg-card"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.3 }}>
